...
export default function Home() {
  ...
  return (
    <div className="page fade-in">
      ...
      {/* Search Bar at Top - Sticky with Premium Blur */}
      <div style={{ 
        position: 'sticky', 
        top: 0, 
        zIndex: 100, 
        ...
        <div className="search-bar" onClick={() => navigate('/search')} style={{ margin: 0 }}>
          ...
          <input readOnly placeholder="Search groceries, snacks..." style={{ fontWeight: 600 }} />
        </div>
      </div>
